...
public class StringUtil {
 ...
 /*
	...
	/**
	    ...
	    private static CharSequence ellipsizeString(CharSequence str, int width, TextPaint textPaint)
	    {
		...
		if (width <= 0)
		{ // view probably hasn't been drawn yet; just return the whole string
		  // to avoid blank textviews
		    return str;
		}
